...
module.exports = { 
    ...
    MESSAGE_REMOVE: "DELETE \"bot_betty_mensages\" where id = $1 OR message ILIKE $1",
    MESSAGE_RANDOM: 'SELECT message FROM bot_betty_mensages ORDER BY RANDOM() LIMIT 1',

    STATUS_READY:  'SELECT * FROM bot_betty_status s WHERE s.channelid = $1 s.created_at = DATE(substring(NOW()::VARCHAR FROM 1 FOR 10));',
